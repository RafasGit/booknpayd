...
const CategoryList = ({ categoryList }) => {
    return (
      <div className="mx-4 md:mx-22 lg:mx-52 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-3 gap-4">  
        {/* for 6 columns: grid-cols-6 */}
          ...
          ? categoryList.map((category, index) => (
              ...
              >
                <Image
                  ...
                  height={35}
                />
                <h2 className="text-primary text-sm md:text-sm">{category.name}</h2>
              </Link>
            ))
